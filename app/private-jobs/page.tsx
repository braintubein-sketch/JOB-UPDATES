        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-20">
            ...
            <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 py-12">
                <div className="container-main">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-400 text-xs font-bold uppercase tracking-wider mb-4">
                        <Briefcase size={14} /> Corporate Careers
                    </div>
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white tracking-tight">
                        Private Sector <span className="text-blue-600">Jobs</span>
                    </h1>
                    <p className="text-slate-600 dark:text-slate-400 text-lg mt-2 max-w-2xl">
                        Explore the latest openings from India's top MNCs and startups. Freshers and experienced roles updated daily.
                    </p>
                </div>
            </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {jobs.length === 0 && (
                        <div className="col-span-full py-24 text-center card">
                            ...
                            <h2 className="text-xl font-bold text-slate-900 dark:text-white">No active Private jobs found.</h2>
                            <p className="text-slate-500 dark:text-slate-400 mt-2">Checking top job boards for fresh corporate notifications.</p>
                        </div>
                    )}
                </div>
            </div>
